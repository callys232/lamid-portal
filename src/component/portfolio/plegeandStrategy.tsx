            ...
            >
              ...
              >
                ...
                <p className="mt-2 text-xs sm:text-sm md:text-base leading-relaxed">
                  ...
                  help clients connect with themselves and their stakeholders,
                  and work to fix in their world, as we use opportunities
                  created by knowledge in the 21st century
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <p className="text-xs sm:text-sm md:text-base leading-relaxed">
                  ...
                  enough cash flow through highly profitable operations to
                  invest in future-focused and create value for its customers
                  through innovation), its impact on the industry, the
                  reputation it creates for itself with its stakeholders, and
                  its business model that gives it the ability to remain healthy
                  for decades. The greatness of a company has a lot to do with
                  its operation; their functions are run by people who are
                  experienced, educated, well prepared, business savvy through
                  common sense and profitability centered. Such companies take
                  advantage of opportunities available in the environment and
